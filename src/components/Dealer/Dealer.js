    ...
    return (
        <>
            <Box className="task_section">
                ...
                <Box sx={{ height: "73vh", margin: 2, padding: 1 }} className="task_cards_section" component={Paper}>
                            ...
                            <TableBody>
                                {
                                    dealerList.map((dealerData) => {
                                        ...
                                        >
                                            ...
                                            <TableCell align="right" sx={{ maxWidth: "150px" }}>{dealerData.companyName}</TableCell>
                                            <TableCell align="right">{dealerData.contact_number}</TableCell>
                                            <TableCell align="right" sx={{ maxWidth: "150px" }}>{dealerData.state}</TableCell>
            ...
            {addDealer.status && <AddDealerDialog handleCloseDialog={handleCloseDialog} addDealer={addDealer} setAddDealer={setAddDealer} AddDealerDetail={AddDealerDetail} />}
        </>
    )
}
