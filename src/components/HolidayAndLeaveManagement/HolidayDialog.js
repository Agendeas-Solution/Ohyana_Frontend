...
const HolidayDialog = ({ addHolidayDialog, handleCloseDialog, addHolidayDetail, setAddHolidayDetail, SetHoliday, UpdateHolidayFunc }) => {
                ...
                <DialogContent>
                            ...
                            <div className="col-md-12">
                                <LocalizationProvider dateAdapter={AdapterDateFns}>
                                    <DatePicker
                                        ...
                                        onChange={(e) => {
                                            setAddHolidayDetail({ ...addHolidayDetail, date: moment(e).format('YYYY-MM-DD') });
                                        }}
                    ...
                    <Box className="py-3">
                        <div className='row'>
                            ...
                            <div className='col-md-12'>
                                <TextField type="number" value={addHolidayDetail.duration} onChange={(e) => {
                                    setAddHolidayDetail({ ...addHolidayDetail, duration: e.target.value });
                                }} className="w-100" placeholder="Enter Holiday Duration " variant="outlined" />
                            </div>
                        </div>
                    </Box>
                    <Box className="py-3">
                        <div className="row">
                            ...
                            <div className='col-md-12'>
                                <TextField
                                    value={addHolidayDetail.occasion} onChange={(e) => {
                                        setAddHolidayDetail({
                                            ...addHolidayDetail, occasion:
                                                e.target.value
                                        });
                                    }}
                                    className="w-100" placeholder="Enter Holiday Duraion " variant="outlined" />
                            </div>
                        </div>
                    </Box>
                </DialogContent>
