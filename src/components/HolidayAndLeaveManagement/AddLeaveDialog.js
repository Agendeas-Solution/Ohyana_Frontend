                ...
                <DialogContent>
                    <Box className="py-3">
                        <div className='row'>
                            ...
                            <div className='col-md-12'>
                                <TextField value={addLeaveDialog.type} onChange={(e) => {
                                    setAddLeaveDialog({ ...addLeaveDialog, type: e.target.value });
                                }} className="w-100" placeholder="Enter Leave Name" variant="outlined" />
                            </div>
                        </div>
                    </Box>
                    <Box className="py-3">
                        <div className="row">
                            ...
                            <div className='col-md-12'>
                                <TextField
                                    type="number"
                                    value={addLeaveDialog.duration} onChange={(e) => {
                                        setAddLeaveDialog({
                                            ...addLeaveDialog, duration:
                                                e.target.value
                                        });
                                    }}
                                    className="w-100" placeholder="Enter Days Leave Name" variant="outlined" />
                            </div>
                        </div>
                    </Box>
                </DialogContent>
