        ...
        <>
            <Box className="business_card_section" >
                {businessCard.map((data) => {
                    ...
                    return <Box className="business_card" onClick={() => setViewBusinessCardDialog({ ...viewBusinessCardDialog, status: true, id: data?.id })}>
            ...
            <ViewBusinessCardDetail handleDialogClose={handleDialogClose} viewBusinessCardDialog={viewBusinessCardDialog} />
        </>
    )
}
