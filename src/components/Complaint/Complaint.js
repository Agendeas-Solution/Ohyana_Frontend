                    ...
                    <Box className="complaint_left_section">
                        <Box className="ticket_detail">
                            <Box className="ticket_number_row">
                                ...
                                <Button onClick={handleCloseTicket} className="close_ticket_button">Close Ticket</Button>
                            </Box>
                            <Box className="row">
                                <Typography className="ticket_sub_heading" variant="span">Date</Typography>
                                <Typography variant="span">{moment(complaintDetail?.date).format('ll')}</Typography>
                            </Box>
                            <Box className="row">
                                <Typography className="ticket_sub_heading" variant="span">Status</Typography>
                                <Typography variant="span">{complaintDetail?.status}</Typography>
                            </Box>
                            <Box className="row">
                                <Typography className="ticket_sub_heading" variant="span">About</Typography>
                                <Typography variant="span">{complaintDetail?.complaintType}</Typography>
                            </Box>
                            <Box className="row">
                                <Typography className="ticket_sub_heading" variant="span">Description</Typography>
                                <Typography variant="span">{complaintDetail?.description}</Typography>
                            </Box>
                        </Box>
                        <Box className="customer_feedback_section">
                            ...
                            <Typography variant="span">{complaintDetail?.complaint_feedback?.description}</Typography>
                        </Box>
                    </Box>
                    <Box className="complaint_right_section">
                        <Box className="customer_feedback_section">
                            <Box className="customer_feedback_heading">
                                ...
                                <Button onClick={
                                    handleClickOpen
                                } className="common_button">Add Status</Button>
                            </Box>
                        </Box>
                        <Typography variant="span">Updates</Typography>
                        {
                            complaintProcesses.length > 0 && complaintProcesses.map((complainUpdates) => {
                                return <Box Box className="complaint_updates">
                                    <Box className="date_cell">
                                        <Typography variant="span">{moment(complainUpdates?.createdAt).format("Do")}</Typography>
                                        <Typography variant="span">{moment(complainUpdates?.createdAt).format("MMM")}</Typography>
                                    </Box>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-12">
                                    <TextareaAutosize
                                        ...
                                        onChange={(e) => {
                                            setTicketAnswer({ ...ticketAnswer, description: e.target.value })
                                        }}
                                    />
                                </div>
                            </div>
