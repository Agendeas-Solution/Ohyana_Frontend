      ...
      <Box className="performance_attendance_row">
          ...
          <Box className="performance_terms">
            <Box className="performance_statistics_data">
              ...
              <Box className="performance_parameter">
                <Typography variant="span">{salesInquiry?.performance?.total}</Typography>
                <Typography variant="span" className="common_icon"><TrendingUpRoundedIcon className="common_icon" />5%</Typography>
              </Box>
            </Box>
            <Box className="performance_statistics_data">
        ...
        <Box className="attendance_section">
          <Box className="attendance_subheading">
            ...
            <Typography sx={{ color: "#8e8e8e" }} variant="span">22 Oct 2022</Typography>
          </Box>
          <Box>
            <Typography variant="span">Check In </Typography>
            <Typography variant="span">:</Typography>
            <Typography variant="span">{salesInquiry?.attendance?.checkIn}</Typography>
          </Box>
          <Box>
            <Typography variant="span">Check Out </Typography>
            <Typography variant="span">:</Typography>
            <Typography variant="span">{salesInquiry?.attendance?.checkOut}</Typography>
          </Box>
          <Box>
            <Typography variant="span">Break In </Typography>
            <Typography variant="span">:</Typography>
            <Typography variant="span">{salesInquiry?.attendance?.breakIn}</Typography>
          </Box>
          <Box>
            <Typography variant="span">Break Out </Typography>
            <Typography variant="span">:</Typography>
            <Typography variant="span">{salesInquiry?.attendance?.breakOut}</Typography>
          </Box>
        </Box>
      </Box>
      <Box className="common_row">
        <Box className="my_task_section">
          ...
          <Box className='my_task_subheading'>
            ...
            <Typography sx={{ color: "#8E8E8E" }} variant="span">Due Date : 22 Oct 2022</Typography>
          </Box>
            ...
            <Table sx={{ minWidth: 250 }} >
              ...
              <TableBody>
                {salesInquiry?.teamPoints.map((value) => {
                  ...
                  >
                    <TableCell align="right"> {moment(value?.createdAt).format("D/MM/YY")}</TableCell>
                    <TableCell align="right">{value?.point?.name}</TableCell>
                    <TableCell align="right"> {value?.point?.points}</TableCell>
                  </TableRow>
                })}
              </TableBody>
            </Table>
