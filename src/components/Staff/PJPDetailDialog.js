    ...
    <>
      <Dialog open={pjpDetailDialog.status} onClose={handleCloseDialog}>
        <div className="px-3 pt-3 common_row">
          <h4>PJP Detail</h4>
          <Box>
            <Button className="common_button" onClick={handleEditPJPOpenDialog}>Edit</Button>
        ...
        <DialogContent>
          ...
          <Box className="common_row">
            ...
            <Typography variant="span">{pjpDetail?.finish_description || "-"}</Typography>
          </Box>
        </DialogContent>
      </Dialog>
      {pjpDetail.status && <EditPJPDialog
