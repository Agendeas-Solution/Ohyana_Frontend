...
const PJPScheduleTable = ({ pjpList }) => {
    ...
    return (
        <>
                    ...
                    <TableBody>
                        {pjpList.map((pjpData, index) => {
                            return <TableRow>
                                ...
                                <TableCell align="left"><Button onClick={() => setPJPDetailDialog({
                                    status: true,id:pjpData.id
            ...
            {pjpDetailDialog.status && <PJPDetailDialog pjpDetailDialog={pjpDetailDialog} handleCloseDialog={handleCloseDialog} setPJPDetailDialog={setPJPDetailDialog}/>}
        </>
    )
}
