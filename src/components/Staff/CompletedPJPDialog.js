...
const CompletedPJPDialog = ({ completedDialog,
    handleCloseCompletedDialog, setCompletedDialog,handleAddCompletePJPStatus }) => {
    return (
        <>
            <Dialog open={completedDialog.status} onClose={handleCloseCompletedDialog}>
                <Box>
                    <DialogTitle
