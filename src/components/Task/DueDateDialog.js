...
const DueDateDialog = ({ dueDateDialogControl, handleDueDateDialogClose, setDueDateDialogControl,handleEditDueDate }) => {
    return (
        <> <Dialog
            ...
            <Box className="popup_section">
                ...
                <LocalizationProvider dateAdapter={AdapterDateFns}>
                    <DatePicker
                        ...
                        onChange={e => {
                            setDueDateDialogControl({ ...dueDateDialogControl, due_date: e })
                        }}
                        renderInput={(params) => (
                            <TextField
                                {...params}
