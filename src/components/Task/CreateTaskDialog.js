...
const CreateTaskDialog = ({ handleClose, fullScreen, open, createTask, handleCreateTask, setCreateTask }) => {
    return (
        <>
            <Dialog
                        ...
                        <div className="col-md-12">
                            <LocalizationProvider dateAdapter={AdapterDateFns}>
                                <DatePicker
                                    ...
                                    onChange={(e) => {
                                        setCreateTask({ ...createTask, due_date: moment(e).format('YYYY-MM-DD') })
                                    }}
