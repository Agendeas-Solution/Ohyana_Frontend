...
const EditDescriptionDialog = ({ editDescriptionDialog, setEditDescriptionDialog, handleDialogClose }) => {
    const handleEditDescription = () => {
        EditTaskDescription({ description: editDescriptionDialog?.description, id: editDescriptionDialog?.id }, (res) => {
            handleDialogClose()
        }, (err) => {
    ...
    return (
        <>
            <Dialog
                open={editDescriptionDialog.status}
