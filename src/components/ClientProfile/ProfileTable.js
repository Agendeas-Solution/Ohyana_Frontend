        ...
        <>
            <Box className="client_profile_table_section" >
                <Box className="client_profile_detail">
                    ...
                    <Box className="userdetail_root">
                        <Typography className="userdetail_field_heading" variant="span">Client stage</Typography>
                        <Box sx={{ maxWidth: "50%" }}>
                            
                        </Box>
                    </Box>
                    <Box className="userdetail_root">
                        <Typography className="userdetail_field_heading" variant="span">Current Business</Typography>
                        <Box sx={{ maxWidth: "50%" }}>
